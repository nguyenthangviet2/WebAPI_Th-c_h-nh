    ...
    public class LibraryService : ILibraryService
    {
        ...
        public async Task<Author> GetAuthorAsync(int id, bool includeBooks)
        {
            try
            {
                ...
                {
                    return await _db.Authors.Include(b => b.BookAuthors)
        ...
        Task<List<BookAuthor>> ILibraryService.GetBookAuthorsAsync()
        {
            throw new NotImplementedException();
        }

        Task<BookAuthor> ILibraryService.GetBookAuthorsAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        Task<BookAuthor> ILibraryService.AdBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        Task<BookAuthor> ILibraryService.UpdateBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        Task<(bool, string)> ILibraryService.DeleteBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        Task<List<Publishers>> ILibraryService.GetPublishersAsync()
        {
            throw new NotImplementedException();
        }

        Task<Publishers> ILibraryService.GetPublishersAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        Task<Publishers> ILibraryService.AddPublishersAsync(Publishers Publisher)
        {
            throw new NotImplementedException();
        }

        Task<Publishers> ILibraryService.UpdatePublishersAsync(Publishers Publisher)
        {
            throw new NotImplementedException();
        }

        Task<(bool, string)> ILibraryService.DeletePublishersAsync(Publishers Publisher)
        {
            throw new NotImplementedException();
        }

        public Task<BookAuthor> AdBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        public Task<BookAuthor> UpdateBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        public Task<(bool, string)> DeleteBookAuthorsAsync(BookAuthor BookAuthors)
        {
            throw new NotImplementedException();
        }

        public Task<Publishers> AddPublishersAsync(Publishers Publisher)
        {
            throw new NotImplementedException();
        }

        public Task<Publishers> UpdatePublishersAsync(Publishers Publishers)
        {
            throw new NotImplementedException();
        }

        public Task<(bool, string)> DeletePublishersAsync(Publishers Publishers)
        {
            throw new NotImplementedException();
        }

        public Task<Publishers> GetPublishersAsync(object iD)
        {
            throw new NotImplementedException();
        }
